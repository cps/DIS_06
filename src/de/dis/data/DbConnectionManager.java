...
public class DbConnectionManager {
	...
	private static de.dis.data.DbConnectionManager _instance = null;
	 ...
	 */
	public static de.dis.data.DbConnectionManager getInstance() {
		if (_instance == null) {
			_instance = new de.dis.data.DbConnectionManager();
		}
		return _instance;
	}
